 ...
 */
	...
	public static void main(String[] args) {
		...
		Sequence<List<Item<Integer,Integer>>, Item<Integer,Integer>, Integer> as = new Array_Seq<>();
		as.build(data);
		//as.insert_at(2, new Item<Integer,Integer>(22,22));
		as.insert_first(new Item<Integer,Integer>(11,11));
		as.insert_last(new Item<Integer,Integer>(99,99));

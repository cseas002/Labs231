...
public class MemoryCell<AnyType> {
    ...
    public static void main(String[] args) {
        ...
        // call of method read to get and print the stored value
        ...
        // the array
        arr[0] = new MemoryCell<>("String0");
        arr[1] = new MemoryCell<>(10);
        arr[2] = new MemoryCell<>(123.567);

        for (int i = 3; i < 5; i++) {
            arr[i] = new MemoryCell<>("String " + i);
        }
        ...
        arr2[1] = new MemoryCell<>(10);
        arr2[2] = new MemoryCell<>(123.567);
